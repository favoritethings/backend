...
public class Spot {
    ...
    @Builder
    public Spot(Member member, Curation curation, String title, String subTitle, String description, String address, String openingHour, Boolean isParking, String featured_image) {
        this.member = member;
